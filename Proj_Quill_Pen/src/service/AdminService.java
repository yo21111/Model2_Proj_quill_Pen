...
public interface AdminService {
	...
	// public NoticeBean writeNotice (String mId, String title, String content)
	// throws Exception;
	...
	// public BookBean bookIntro (String fileName, String title, String subTitle,
	// String imageName, String category, String link) throws Exception;
