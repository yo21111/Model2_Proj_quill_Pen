...
public interface HomeService {
	...
	// 공지사항 클릭시
	public NoticeBean read (HttpServletRequest req, HttpServletResponse resp) throws Exception;
	...
	// 검색어 입력시
	public BoardBean search (HttpServletRequest req, HttpServletResponse resp) throws Exception;
	...
	// 피드 선택시
	public BoardBean writer (HttpServletRequest req, HttpServletResponse resp) throws Exception;
